        ...
        if($_SESSION['loged']){
            ...
            if($request_type == 'get'){
                ...
                if($cart_table){
                    ...
                    $response = array(
                        "status" => false,
                        "body" => "Problemas ao conectar a base de dados"
                    );
                }
                ...
                $query = $m_db->prepare("DELETE FROM CART WHERE id = :cartId");
                // Bind the parameter
                $query->bindParam(":cartId", $id);
                // Execute the query
                $query->execute();
                ...
                if($query){
                    ...
                    $response = array(
                        "status" => false,
                        "body" => "Não foi possivel remover o item"
                    );
                }
